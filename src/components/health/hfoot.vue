<template>
  <div id="foot">
	  	<div class="foot-nav" :class="tfoot==1?'fthis':''" @click="opennew('hindex')">
				<img src="../../../static/huan-guiji-active.png" class="factive" />
				<img src="../../../static/huan-guiji.png" class="fdefault" />
				<span>
	    			工作轨迹
	    	</span>
			</div>
