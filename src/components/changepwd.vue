<template>
	<div class="warpper revise">
		...
		<div class="main" style="overflow: scroll;padding-top: .7rem;">
			<img src="../../static/title.png" class="title">
			<div class="content">
				<div class="box-group">
...
<style type="text/css" lang="scss">
	...
	.revise .form-group .reg {
		position: absolute;
		background: url(../../static/yzkuangn.png) no-repeat;
		width: 1.8rem;
		height: 100%;
